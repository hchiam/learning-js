...
(function () {
  ...
  inputGroupdDiv.style =
    "border-radius: 0.3rem !important; display: inline-block !important; border: 2px solid lightgrey !important;";
  ...
  consoleOutput.style =
    "margin-top: 1px !important; max-height: 100px !important; overflow: scroll !important; background: black !important; color: white !important; border: none !important; border-radius: 0.3rem !important;";
  ...
  function inputToConsole(stringInput) {
    ...
    // display input:
    console.log(
      '<span style="background: black; color: lime;">' + stringInput + "</span>"
    );
    try {
