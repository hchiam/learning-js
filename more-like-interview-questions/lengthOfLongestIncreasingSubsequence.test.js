...
const {
  solutionWrapper,
} = require("./lengthOfLongestIncreasingSubsequence.js");
...
describe("index", () => {
  ...
  it("works", () =>
    expect(solutionWrapper([10, 9, 2, 5, 3, 7, 101, 18])).toBe(4));
  it("works", () => expect(solutionWrapper([0, 1, 0, 3, 2, 3])).toBe(4));
  it("works", () => expect(solutionWrapper([7, 7, 7, 7, 7, 7, 7])).toBe(1));
});
